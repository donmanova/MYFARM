...
/**
 * Created by Gideon on 4/16/2015.
 */
public class FarmLocation extends Service implements LocationListener{
    ...
    public FarmLocation(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(FarmLocation.this);
        }
    }
